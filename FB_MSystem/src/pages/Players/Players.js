...
function Players() {
    ...
    const handleDeletePlayer = (id) => {
        ...
        setPlayers({
            ...
            [selectedSeason]: {
                ...
                [teamId]: teamPlayers.filter(player => player.id !== id),
            },
        });
    };
    ...
    const handleUndoDelete = () => {
        if (deletedPlayer) {
            const updatedPlayers = [
                ...(players[deletedPlayer.season]?.[deletedPlayer.teamId] || []),
                deletedPlayer,
            ];
            setPlayers({
                ...players,
                [deletedPlayer.season]: {
                    ...players[deletedPlayer.season],
                    [deletedPlayer.teamId]: updatedPlayers,
                },
            });
